                      ...
                      <div className="difference__single-wrapper">
                        ...
                        >
                          ...
                          <div className="difference__single-content">
                            ...
                            <p>
                              Providing nutritious meals to the homeless and
                      ...
                      <div className="difference__single-wrapper">
                        ...
                        >
                          ...
                          <div className="difference__single-content">
                            ...
                            <p>
                              Offering a safe space and medical care to
                              abandoned and homeless individuals.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="swiper-slide px-2">
                      <div className="difference__single-wrapper">
                        ...
                        >
                          ...
                          <div className="difference__single-content">
                            <h5>
                              <Link href="/cause-details">Rehabilitation</Link>
                            </h5>
                            <p>
                              Ensuring timely healthcare and rehabilitation for
                              the helpless.
                            </p>
                          </div>
                        </div>
